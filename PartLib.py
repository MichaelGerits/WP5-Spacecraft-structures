...
class StructuralCylinder:
    ...
    """
    def __init__(self, R=0.28, h=1.5, t=0, E=110.3e9, SigmaY=980e6, rho=0, critical_euler_stress=0, critical_shell_stress=0, Poisson=0.32, buckling_k=0, half_waves=0):
        self.R = R
        self.h = h
        self.t = t
        self.E = E
